...
<body>
	...
	<!-- form action -->
		<a id="home" href="./"><img class="logo-tittle" src="img/logo_001.png">EXELCO</a>		
  		<form class="right" action="close.php">
  			<span id="dateshow"><i class="icon fas fa-calendar-alt"></i><?php if(!isset($dateshow)) echo date('F j, Y'); else echo $dateshow; ?></span>
  			<span id="username"><i class="icon fa fa-user"></i><?php echo $_SESSION['name'];?></span>
  			<?php if ($_SESSION['user'] == 'admin'): ?>
            <a class="nav-link js-scroll-trigger btn btn-success btn-sm" href="./aconfig.php" style="color: white;"><i class="fas fa-cog"></i></a>  
          <?php endif;?>
  			<button class="button full">Log off<i class="icon fas fa-sign-out-alt"></i></button><button class="button media"><i class="icon fas fa-sign-out-alt"></i></button>
  		</form>
	</ul>
