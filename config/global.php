...
define("ORCL_INSTEAD", "(DESCRIPTION=( ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP) (HOST = 10.0.1.3) (PORT=1521)))( CONNECT_DATA = (SERVICE_NAME = DB01_iad22z.sub01192138581.vcnexelco.oraclevcn.com) ))");
